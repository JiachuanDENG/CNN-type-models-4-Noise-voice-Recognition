...
if __name__ == '__main__':
    ...
    wanted_words='testnoisydata,noise'
    trainx,trainy,valx,valy,model_settings=dataprocessing.returnData(datadir='../../data/selfbuildDataTest/',\
    ...
    for modelName in modelNameList:
        ...
        # testx[:int(float(testPercentage)*testx.shape[0])],testy[:int(float(testPercentage)*testx.shape[0])]
